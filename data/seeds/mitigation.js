...
exports.seed = (knex) => knex('mitigation').del()
  .then(() => knex('mitigation').insert([
    ...
    {
      id: 'M3',
      description: 'Establish and enforce policy to regularly change office locks',
      is_hq: true,
      is_local: true,
      hq_cost: 250,
      local_cost: 250,
    ...
    {
      id: 'M5',
      description: 'Require two-factor authentication and strong passwords for accessing the online party voter database',
      is_hq: true,
      is_local: false,
      hq_cost: 750,
      local_cost: '',
    ...
    {
      id: 'M6',
      description: 'Establish and enforce an account management and offboarding policy for the online party voter database',
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M8',
      description: 'Host the Party website with a secure web-hosting provider',
      is_hq: true,
      is_local: false,
      hq_cost: 750,
      local_cost: '',
    ...
    {
      id: 'M9',
      description: 'Require two-factor authentication for logging into the Party website',
      is_hq: true,
      is_local: false,
      hq_cost: 750,
      local_cost: '',
    ...
    {
      id: 'M10',
      description: 'Establish and enforce a content management policy for the Party website',
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M14',
      description: "Require two-factor authentication for Alissa Orme's personal email account",
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M15',
      description: "Require a strong password for Alissa Orme's personal email account",
      is_hq: true,
      is_local: false,
      hq_cost: 250,
      local_cost: '',
    ...
    {
      id: 'M16',
      description: 'Require two-factor authentication and strong password for Party Twitter account',
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M18',
      description: 'Establish and enforce Twitter account management policy',
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M20',
      description: 'Require strong passwords on all administrator accounts for Party Facebook pages',
      is_hq: true,
      is_local: true,
      hq_cost: 500,
      local_cost: 500,
    ...
    {
      id: 'M22',
      description: 'Establish and enforce communications policy across all Party Facebook pages',
      is_hq: true,
      is_local: false,
      hq_cost: 500,
      local_cost: '',
    ...
    {
      id: 'M29',
      description: 'Regularly update operating system on all Party staff/volunteer computers',
      is_hq: true,
      is_local: true,
      hq_cost: 750,
      local_cost: '1,250.00',
    ...
    {
      id: 'M30',
      description: 'Only allow approved software on all Party staff/volunteer computers',
      is_hq: true,
      is_local: true,
      hq_cost: 750,
      local_cost: 750,
    ...
    {
      id: 'M31',
      description: 'Only allow approved apps on all Party staff/volunteer mobile devices',
      is_hq: true,
      is_local: true,
      hq_cost: 750,
      local_cost: 750,
